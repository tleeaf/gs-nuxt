<template>
  <!-- <head>
    ...
    <link href="../assets/banner.css" rel="stylesheet" />
  </head> -->
        ...
        <div class="row-fluid">
          ...
          <div id="button-container">
            ...
            <div class="icon-container" id="icon-container-az">
              <button class="btn btn-popup-control" id="uconn-az" href="https://uconn.edu/az" aria-haspopup="true"
                aria-controls="a-z-popup" aria-expanded="false">
